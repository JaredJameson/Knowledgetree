...
function App() {
  return (
    <Routes>
      ...
      <Route path="/categories/:categoryId/edit" element={<ProtectedRouteWithLayout><ContentEditorPage /></ProtectedRouteWithLayout>} />
      ...
      <Route path="/account" element={<ProtectedRouteWithLayout><AccountPage /></ProtectedRouteWithLayout>} />
      ...
      <Route path="/graph" element={<ProtectedRouteWithLayout><KnowledgeGraphPage /></ProtectedRouteWithLayout>} />
